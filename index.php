...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #72dc8a">
              ...
              <div class="col-sm-12 col-md img text-center">
                ...
                <h3>Welcome to</h3>
                <h1 style="color:black;">SPARKS BANK</h1>
              </div>
            </div>
            <div class="col-sm-12 col-md img text-center">
     ...
     <footer class="text-center mt-5 py-2" style="color:white;">
        <p>&copy 2021 Made by <b>KRISHNA KUMAR SHAH</b></p>
      </footer>
